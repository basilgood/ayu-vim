...
let s:palette.guide     = {'dark': "#242A35",  'light': "#D9D8D7",  'mirage': "#3D4751"}
...
exe "hi! TabLine"       .s:fg_fg          .s:bg_bg          .s:fmt_none
exe "hi! TabLineFill"   .s:fg_fg          .s:bg_bg          .s:fmt_none
exe "hi! TabLineSel"    .s:fg_fg          .s:bg_panel       .s:fmt_none
...
exe "hi! PreProc"         .s:fg_statement .s:bg_none        .s:fmt_none
"   Include"
"   Define"
"   Macro"
"   PreCondit"
