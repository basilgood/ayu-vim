...
let s:fg = {}
let s:fg.primary    = {'dark': '#B3B1AD', 'light': '#5C6773', 'mirage': '#D9D7CE'}[s:style]
...
let s:bg = {}
let s:bg.primary    = {'dark': '#142233', 'light': '#DEE8F1', 'mirage': '#2A3546'}[s:style]
...
let s:p.tabline.left    = [[s:fg.primary, s:bg.secondary]]
let s:p.tabline.tabsel  = [[s:fg.primary, s:bg.primary]]
